...
function WhyLipLuxe() {
  return (
    <>
      <div className="px-6 sm:px-6 lg:px-8 bg-[#f7f7f7]">
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 px-7 sm:space-x-9 sm:pl-6 lg:mr-11 xl:mr-0 xl:space-x-0 xl:ml-40 mL:pl-24 mM:pl-16 bg-[#f7f7f7]">
