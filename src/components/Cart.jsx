        ...
        <Modal
          ...
          children={
            <div>
              ...
              <p className='text-grey-800  m-4 font-semibold'>I sincerely apologize for the inconvenience, but the checkout functionality is currently unavailable as the backend service is not yet implemented. This version of the application only includes the frontend portion for demo purposes.</p>
